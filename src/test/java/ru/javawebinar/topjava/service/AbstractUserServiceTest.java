...
//        ActiveProfiles declaredAnnotation = this.getClass().getDeclaredAnnotation(ActiveProfiles.class);
//        if (!Arrays.stream(declaredAnnotation.value()).anyMatch(Profiles.JDBC::equals)) {
        if (!isJdbc()) {
