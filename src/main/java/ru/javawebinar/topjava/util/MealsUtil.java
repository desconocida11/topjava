...
public class MealsUtil {
    ...
    public static final List<Meal> MEALS_INIT = Arrays.asList(
            ...
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 30, 21, 0), "Дожор", 100),
    ...
    public static void main(String[] args) {
        List<MealTo> mealsTo = filteredByStreams(MEALS_INIT, LocalTime.of(7, 0), LocalTime.of(12, 0), 2000);
